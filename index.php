...
<body>
	...
	<div id="app">
		...
		<main class="p-2 p-md-3 mx-xl-auto my-xl-4">
			<section id="inputs" :class="{ 'tab-active': active_tab === 'form' }">
				...
				<div class="container">
					<form class="row needs-validation" novalidate method="post" @submit.prevent="ad_form_submit($event.target)">
						...
						<div class="col-md-6">
							...
							<input pattern=".{2,}" v-model="form_data.name_of_company" id="name_of_company" type="text" class="form-control" placeholder="adspin" name="name_of_company" required />
						...
						<div class="col-md-6">
							...
							<input  pattern="^(\w+(\s+\w+)*)([,.;](\s+\w+)+){2}$" v-model="form_data.key_features" id="key_features" type="text" class="form-control" placeholder="fast, fresh, effective" name="key_features" required />
							<div class="invalid-feedback">
			...
			<section id="ads_grid" :class="{ 'tab-active': active_tab === 'listing' }">
				<div class="container-fluid">
					<div class="row gy-3" v-for="ads_row in ads">
						<div class="col-12 col-sm-6 col-md-4 col-lg-3 px-1 pb-2" v-for="ad in ads_row">
							<img :src="ad.img_url" alt="sample ad"  @touchend="ad_touch_service(ad, $event)">
							<button type="button" class="like-button" :liked="ad.liked" @click="ad_liked_toggle(ad)">
							</button>
						</div>
					</div>
				</div>
				<div class="d-flex justify-content-center" id="observed_target" style="width:100%;">
